...
class ManualClassifierGUI:
    def __init__(self, pdf_path, output_file="output.txt"):
        ...
        self.root.bind('1', lambda event: self.classify(0))
        self.root.bind('2', lambda event: self.classify(1))
        self.root.bind('3', lambda event: self.classify(2))
        self.root.bind('4', lambda event: self.classify(3))
